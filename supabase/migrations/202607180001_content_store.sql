...
COMMENT ON COLUMN content_attendance.shop_id IS 'Denormalized from content_profiles.shop_id. Application layer must validate that shop_id matches the profile row.';
