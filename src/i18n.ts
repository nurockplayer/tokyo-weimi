...
const common = {
  zhHant: {
    ...
    labels: {
      ...
      lineGallery: "圖片集",
      supportScreenshots: "LINE / 聊天截圖",
      supplementalMedia: "補充圖片",
      viewPhoto: "查看第",
...
export const dictionaries = {
  ...
  "zh-Hans": {
    ...
    labels: {
      ...
      lineGallery: "图片集",
      supportScreenshots: "LINE / 聊天截图",
      supplementalMedia: "补充图片",
      viewPhoto: "查看第",
  ...
  ja: {
    ...
    labels: {
      ...
      lineGallery: "画像ギャラリー",
      supportScreenshots: "LINE / チャット画像",
      supplementalMedia: "補足画像",
      viewPhoto: "写真",
  ...
  ko: {
    ...
    labels: {
      ...
      lineGallery: "이미지 갤러리",
      supportScreenshots: "LINE / 채팅 캡처",
      supplementalMedia: "보충 이미지",
      viewPhoto: "사진",
  ...
  en: {
    ...
    labels: {
      ...
      supportScreenshots: "LINE / chat screenshots",
      supplementalMedia: "Supplemental images",
