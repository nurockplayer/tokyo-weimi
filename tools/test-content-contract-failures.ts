...
function baseData(): Record<string, unknown> {
  return {
    shops: [
      { id: "shop-a", name: "Shop A", shortName: "A", sourceUrl: "https://example.com", contact: { phone: "000", line: "", secondaryLine: "", lineQr: "", secondaryLineQr: "", area: "", hours: "" } },
    ],
...
test("profile missing required string field", () => {
  expectThrow(() => {
    const snap = validSnapshot({
      data: {
        ...baseData(),
...
test("profile tags not a string array", () => {
  expectThrow(() => {
    const snap = validSnapshot({
      data: {
        ...baseData(),
        profiles: [
          { id: "p1", shopId: "shop-a", name: "", title: "", date: "", image: "img1", gallery: ["img1"], origin: "", age: "", height: "", weight: "", cup: "", tags: [123], price: "", summary: "" },
        ],
      },
    });
    assertContentSnapshotV1(snap);
...
test("shop missing sourceUrl", () => {
  expectThrow(() => {
    const snap = validSnapshot({
      data: {
        ...baseData(),
        shops: [{ id: "shop-a", name: "Shop A" }],
      },
    });
    assertContentSnapshotV1(snap);
  }, "shops[0].sourceUrl must be a string");
});

test("profile shopId references unknown shop", () => {
  expectThrow(() => {
    const snap = validSnapshot({
      data: {
        ...baseData(),
        profiles: [
          { id: "p1", shopId: "nonexistent-shop", name: "", title: "", date: "", image: "img1", gallery: ["img1"], origin: "", age: "", height: "", weight: "", cup: "", tags: [], price: "", summary: "" },
        ],
      },
    });
    assertContentSnapshotV1(snap);
  }, "shopId references unknown shop");
});

test("price plan not an object", () => {
  expectThrow(() => {
    const snap = validSnapshot({
      data: {
        ...baseData(),
    ...
    assertContentSnapshotV1(snap);
  }, "pricePlans[0] must be an object");
});

test("price plan missing rows", () => {
  expectThrow(() => {
    const snap = validSnapshot({
      data: {
        ...baseData(),
        pricePlans: [{ name: "Plan", note: "" }],
      },
    });
    assertContentSnapshotV1(snap);
  }, "pricePlans[0].rows must be an array");
});

test("profile isToday not boolean", () => {
  expectThrow(() => {
    const snap = validSnapshot({
      data: {
        ...baseData(),
        profiles: [
          { id: "p1", shopId: "shop-a", name: "", title: "", date: "", image: "img1", gallery: ["img1"], origin: "", age: "", height: "", weight: "", cup: "", tags: [], price: "", summary: "", isToday: "false" },
        ],
      },
    });
    assertContentSnapshotV1(snap);
  }, "isToday must be a boolean");
});
...
test("contact missing secondaryLine", () => {
  expectThrow(() => {
    const snap = validSnapshot({
      data: {
        ...baseData(),
        contact: { phone: "000", line: "", lineQr: "", area: "", hours: "" },
      },
    });
    assertContentSnapshotV1(snap);
  }, "contact.secondaryLine must be a string");
});

test("shop missing shortName", () => {
  expectThrow(() => {
    const snap = validSnapshot({
      data: {
        ...baseData(),
        shops: [{ id: "shop-a", name: "Shop A", sourceUrl: "https://example.com" }],
      },
    });
    assertContentSnapshotV1(snap);
  }, "shops[0].shortName must be a string");
});

test("shop missing contact", () => {
  expectThrow(() => {
    const snap = validSnapshot({
      data: {
        ...baseData(),
        shops: [{ id: "shop-a", name: "Shop A", shortName: "A", sourceUrl: "https://example.com" }],
      },
    });
    assertContentSnapshotV1(snap);
  }, "shops[0].contact must be an object");
});

test("profile supportScreenshots refs missing image", () => {
  expectThrow(() => {
    const snap = validSnapshot({
      data: {
        ...baseData(),
        profiles: [
          { id: "p1", shopId: "shop-a", name: "", title: "", date: "", image: "img1", gallery: ["img1"], origin: "", age: "", height: "", weight: "", cup: "", tags: [], price: "", summary: "", supportScreenshots: ["missing-img"] },
        ],
      },
    });
    assertContentSnapshotV1(snap);
...
test("profile supplementalMedia refs missing image", () => {
  expectThrow(() => {
    const snap = validSnapshot({
      data: {
        ...baseData(),
        profiles: [
          { id: "p1", shopId: "shop-a", name: "", title: "", date: "", image: "img1", gallery: ["img1"], origin: "", age: "", height: "", weight: "", cup: "", tags: [], price: "", summary: "", supplementalMedia: ["missing-img"] },
        ],
      },
    });
    assertContentSnapshotV1(snap);
...
test("imageMap value not a string", () => {
  expectThrow(() => {
    const snap = validSnapshot({
      imageMap: { img1: null, img2: "https://example.com/img2.jpg" },
    });
    assertContentSnapshotV1(snap);
  }, 'imageMap["img1"] must be a string');
});

test("contact lineQr references missing image", () => {
  expectThrow(() => {
    const snap = validSnapshot({
      data: {
        ...baseData(),
        contact: { phone: "000", line: "", secondaryLine: "", lineQr: "bad-qr", secondaryLineQr: "", area: "", hours: "" },
      },
    });
    assertContentSnapshotV1(snap);
  }, "lineQr references missing image id");
});

test("shop contact missing line", () => {
  expectThrow(() => {
    const snap = validSnapshot({
      data: {
        ...baseData(),
        shops: [{ id: "shop-a", name: "Shop A", shortName: "A", sourceUrl: "https://example.com", contact: { phone: "000" } }],
      },
    });
    assertContentSnapshotV1(snap);
  }, "shops[0].contact.line must be a string");
});

test("hotel image references missing image", () => {
  expectThrow(() => {
    const snap = validSnapshot({
      data: {
        ...baseData(),
        hotels: [{ area: "", address: "", image: "bad-hotel-img" }],
      },
    });
    assertContentSnapshotV1(snap);
  }, "hotels[0].image references missing image id");
});

test("shop contact missing secondary fields", () => {
  expectThrow(() => {
    const snap = validSnapshot({
      data: {
        ...baseData(),
        shops: [{ id: "shop-a", name: "Shop A", shortName: "A", sourceUrl: "https://example.com", contact: { phone: "000", line: "", lineQr: "", area: "", hours: "" } }],
      },
    });
    assertContentSnapshotV1(snap);
  }, "shops[0].contact.secondaryLine must be a string");
});

test("hotel not an object", () => {
  expectThrow(() => {
    const snap = validSnapshot({
      data: {
        ...baseData(),
...
test("hotel missing address", () => {
  expectThrow(() => {
    const snap = validSnapshot({
      data: {
        ...baseData(),
        hotels: [{ area: "", image: "img1" }],
      },
    });
    assertContentSnapshotV1(snap);
