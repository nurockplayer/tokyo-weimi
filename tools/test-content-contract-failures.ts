...
function baseData(): Record<string, unknown> {
  return {
    shops: [
      { id: "shop-a", name: "Shop A", shortName: "A", contact: { phone: "000", line: "", secondaryLine: "", lineQr: "", secondaryLineQr: "", area: "", hours: "" } },
    ],
...
test("shop missing contact", () => {
  expectThrow(() => {
    const snap = validSnapshot({
      data: {
        ...baseData(),
        shops: [{ id: "shop-a", name: "Shop A", shortName: "A" }],
      },
    });
    assertContentSnapshotV1(snap);
...
test("shop contact missing line", () => {
  expectThrow(() => {
    const snap = validSnapshot({
      data: {
        ...baseData(),
        shops: [{ id: "shop-a", name: "Shop A", shortName: "A", contact: { phone: "000" } }],
      },
    });
    assertContentSnapshotV1(snap);
...
test("shop contact missing secondary fields", () => {
  expectThrow(() => {
    const snap = validSnapshot({
      data: {
        ...baseData(),
        shops: [{ id: "shop-a", name: "Shop A", shortName: "A", contact: { phone: "000", line: "", lineQr: "", area: "", hours: "" } }],
      },
    });
    assertContentSnapshotV1(snap);
